...
const TimelineItem = React.forwardRef<HTMLLIElement, TimelineItemProps>(
  (
    ...
    const content = (
      // this 2fr leads to the timeline not being centered but the description has more space
      <div
        className="grid grid-cols-[1fr_auto_2fr] gap-4 items-start"
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          {showConnector && (
            <div className="h-14 w-0.5 bg-border mt-2" />
          )}
        </div>
